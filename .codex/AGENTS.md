...
- Do not make the Default Identity Domain's **Access Signing Certificate** a deployment requirement. The lab was live-validated with that setting disabled; it remains a tenant security-policy decision.
